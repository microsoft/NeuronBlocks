...
This function integrates with [NNI](https://github.com/microsoft/nni) to try multiple set of hyperparameters generated by various tuning algorithms and run on different training environment. You can use `pip install nni` to install the dependency.
