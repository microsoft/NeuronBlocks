...
* `exp.py`: Function `get_hyperparameters` accepts the model from `model.json` as a parameter and get new hyperparameters from NNI. Some configurations in the model are replaced by the new hyperparameters manually in the function.
